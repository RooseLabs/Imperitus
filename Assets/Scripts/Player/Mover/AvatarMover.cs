...
namespace RooseLabs.Player
{
    ...
    public partial class AvatarMover : MonoBehaviour
    {
        ...
        [Header("Physics")]
        [SerializeField] private Vector3 _gravityAccel = Vector3.down * 9.81f;
        ...
        [SerializeField][Min(0)] private int _slopeApproxIters = 5;
        ...
        {
            ColliderUtil.SetHeight(_collider, _height, _stepUpHeight, _colliderOffset);
